...
<script type="text/javascript">
function add(){
   if(document.userLogin.stuno.value=="")
   {
       alert("请输入学号");
       return;
   }
   ...
   if(document.userLogin.cardno.value=="")
   {
       alert("请输入卡号");
       return;
   }
   if(document.userLogin.cardpassword.value=="")
   {
       alert("请输入卡密码");
       return;
   }
...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(<%=path %>/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">学生添加 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
          <DIV><form action="<%=path %>/stuadd.action" method="post" name="userLogin">
            <TABLE class=gridView id=ctl00_ContentPlaceHolder2_GridView1 
      style="WIDTH: 100%; BORDER-COLLAPSE: collapse" cellSpacing=0 rules=all 
      border=1>
              <TBODY>
                <TR>
                  <TD class=gridViewItem>学号</TD> <TD class=gridViewItem><input type="text" id="stuno" name="stuno"></TD>
                </TR>
                 <TR>
                  <TD class=gridViewItem>用户名</TD> <TD class=gridViewItem><input type="text" id="username" name="username"></TD>
                </TR>
                 <TR>
                  <TD class=gridViewItem>密码</TD> <TD class=gridViewItem><input type="text" id="password" name="password"></TD>
                </TR>
                 <TR>
                  <TD class=gridViewItem>卡号</TD> <TD class=gridViewItem><input type="text" id="cardno" name="cardno"></TD>
                </TR>
                 <TR>
                  <TD class=gridViewItem>卡密码</TD> <TD class=gridViewItem><input type="text" id="cardpassword" name="cardpassword"></TD>
                </TR>
                 <TR>
                  <TD class=gridViewItem>姓名</TD> <TD class=gridViewItem><input type="text" id="realname" name="realname"></TD>
                </TR>
                 <TR>
                  <TD class=gridViewItem>电话</TD> <TD class=gridViewItem><input type="text" id="tel" name="tel"></TD>
                </TR>
                 <TR>
