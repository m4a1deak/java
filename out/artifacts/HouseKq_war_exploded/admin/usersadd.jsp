...
<script type="text/javascript">
function add(){
   if(document.userLogin.no.value=="")
   {
       alert("请输入工号");
       return;
   }
...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(<%=path %>/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">人员添加 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
          <DIV><form action="<%=path %>/usersadd.action" method="post" name="userLogin">
            <TABLE class=gridView id=ctl00_ContentPlaceHolder2_GridView1 
      style="WIDTH: 100%; BORDER-COLLAPSE: collapse" cellSpacing=0 rules=all 
      border=1>
              <TBODY>
                <TR>
                  <TD class=gridViewItem>工号</TD> <TD class=gridViewItem><input type="text" id="no" name="no"></TD>
                </TR>
                <TR>
                 ...
                 <TR>
                  <TD class=gridViewItem>科室</TD> <TD class=gridViewItem>
                  	...
                  	%>
                  		<option value="<%=bean.getId()%>"><%=bean.getNames()%></option>
                  		<%} %>
                  	</select>
                  </TD>
                </TR>
