...
<script type="text/javascript">
function add(){
   if(document.userLogin.names.value=="")
   {
       alert("请输入科室名");
       return;
   }
...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(<%=path %>/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">科室修改 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
          <DIV><form action="<%=path %>/ksmodify.action" method="post" name="userLogin">
      ...
      border=1>
              <TBODY>
                 <TR>
                  <TD class=gridViewItem>科室名</TD> <TD class=gridViewItem><input type="text" id="names" name="names" value="<%=bean.getNames() %>"></TD>
                </TR>
                 <TR>
