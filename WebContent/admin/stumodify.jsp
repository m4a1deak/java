...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(<%=path %>/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">学生修改 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
          <DIV><form action="<%=path %>/stumodify.action" method="post" name="userLogin">
      ...
      border=1>
              <TBODY>
                 ...
                 <TR>
                  <TD class=gridViewItem>卡密码</TD> <TD class=gridViewItem><input type="text" id="cardpassword" name="cardpassword" value="<%=bean.getCardpassword() %>"></TD>
                </TR>
                 <TR>
